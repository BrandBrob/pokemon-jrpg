let playerHealthNumber, enemyHealthNumber, playerHealthBar, enemyHealthBar

document.addEventListener("DOMContentLoaded", ( ) => {
    playerHealthNumber = document.querySelector(".health-num-player")
    enemyHealthNumber = document.querySelector(".enemy-health-num")
...
const aplyDamage = (damage,enemyStats)=>{
    enemyHealthNumber = document.querySelector(".enemy-health-num")
    enemyHealthBar = document.querySelector(".enemy-health-bar")
    console.log(enemyStats.HP - damage)
