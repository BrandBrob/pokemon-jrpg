...
import{getItems,listItems,healingItems} from "/code/items.js"
import { playerPokemons,selecctedPokemon2,baseLevelPokemon,assingPokemonStats, calculateDamage, checkEfectivines,checkWeaknessType, calculateEnemyToPlayerDamage,dataTeam,addInformationPlayer,addInformationEnemy } from "/code/stats.js";
import {enemyHealthNumber,aplyDamage,aplyDamageToPlayer,playerHealthBar,enemyHealthBar,updateHealthBar,types} from "/code/damageTakedDom.js";
import {enemyAI,enemyAttacks} from "/code/enemyAI.js"
import {cryPokemon,lowHp,BGaudio,playLowHpMusic,playBGmusic} from "/code/audio.js"
...
const assingDefaultPokemons = (player1, player2)=> {
enemyName.innerHTML = player2
